...
////////////////////////////////////////////////////////////	
        ...
        submit.setBounds(800,610,150,30);
     ...
     public void paint(Graphics g){
         super.paint(g);
         String time="Time Left-" + timer + " secnds";
        g.setColor(Color.PINK);
        g.setFont(new Font("Tahoma",Font.BOLD,20));
        
         if(timer>0){
         g.drawString(time,750, 470);
         }
         else{
                 g.drawString("TIME UP!!",750, 470);
         } 
         timer--;
